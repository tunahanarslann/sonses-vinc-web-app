...
export const metadata: Metadata = {
  title: "Vinç Kiralama Hizmetleri İstanbul & Samsun | Mobil Vinç, Sepetli Platform",
  description: "İstanbul ve Samsun'da kapsamlı vinç kiralama hizmetleri. Mobil vinç, sepetli platform, ağır yük taşıma, vinç operatörü ve endüstriyel montaj çözümleri.",
  keywords: "vinç kiralama hizmetleri İstanbul, vinç kiralama hizmetleri Samsun, mobil vinç kiralama, sepetli platform kiralama, ağır yük taşıma, vinç operatörü",
  alternates: {
    canonical: "https://www.sonsesvinc.com/hizmetlerimiz",
  },
  openGraph: {
    title: "Vinç Kiralama Hizmetleri İstanbul & Samsun | Sonses Vinç",
    description: "İstanbul ve Samsun'da kapsamlı vinç kiralama hizmetleri. Mobil vinç, sepetli platform ve ağır yük taşıma çözümleri.",
    type: "website",
    locale: "tr_TR",
  },
};
...
const Hizmetlerimiz = () => {
  return (
    <section className={styles.ourServicesPageSection}>
      <div className={styles.ourServicesPageContainer}>
        <h1 className={styles.pageTitle}>İstanbul ve Samsun Vinç Kiralama Hizmetlerimiz</h1>
        <p className={styles.pageDesc}>
          İstanbul ve Samsun'da kapsamlı vinç kiralama, ağır yük taşıma ve endüstriyel çözümler için profesyonel hizmetler sunuyoruz. 
          Mobil vinç, sepetli platform kiralama ve vinç operatörü hizmetlerimizle her türlü projenizde yanınızdayız. 
          İhtiyacınıza uygun çözümü bulmak için bizimle iletişime geçebilirsiniz.
        </p>
        
        {/* Hizmetler Bölümü */}
        <div className={styles.servicesSection}>
          <h2 className={styles.sectionTitle}>İstanbul ve Samsun Vinç Kiralama Hizmet Alanlarımız</h2>
