...
export const metadata: Metadata = {
  title: "Referanslar",
  description:
    "Sonses Vinç ile çalışan bazı iş ortaklarımız ve müşterilerimizin görüşleri. Vinç kiralama referanslarımız.",
  alternates: {
    canonical: "https://www.sonsesvinc.com/referanslar",
  },
};
  ...
  return (
    <section className={styles.referencesSection}>
      <div className={styles.referencesContainer}>
        <h1 className={styles.pageTitle}>Referanslar</h1>
        <p className={styles.pageDesc}>
          Büyük ölçekli projelerde güvenilir ve profesyonel hizmet verdiğimiz referanslarımız. 
          Farklı sektörlerde ve farklı coğrafyalarda başarıyla tamamladığımız projelerimiz.
        </p>
